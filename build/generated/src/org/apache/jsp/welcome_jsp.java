...
public final class welcome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <header>\n");
      out.write("                    <p>A new Product of  <a href=\"product.jsp\">Apple</a></p>\n");
      ...
      out.write("                                <a href=\"error_1.jsp\" class=\"button alt\">Read More</a>\n");
      out.write("                            </footer>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      ...
      out.write("         ");
            ...
            for (Product sp : listt) {
                ...
                out.print("<tr style='text-align: center;'><td>" + sp.getCode() + "</td>"
                        + "<td><img style='width:100px; height:70px;' src='images/" + sp.getImage() + "'/></td>"
                        + "<td>" + sp.getName() + "</td>"
                        + "<td>" + sp.getPrice() + "$</td>"
                        + "<td><input type=\"submit\"value=\"Add to Cart\" name=\"action\" class='button'/></td>"
